...
train_data = torch.load('./datasets/wf_top_sgnum_train.pt')
val_data = torch.load('./datasets/wf_top_sgnum_validation.pt')
test_data = torch.load('./datasets/wf_top_sgnum_test.pt')
wandb.init(project="equiformer_v2_fine_tune",id = "wftopsgnum",resume="allow")
...
stats = np.load("./datasets/wf_top_sgnum_stats.npz")      # ← your saved normalization constants
...
# Load Checkpoint
checkpoint_path = "./checkpoints/wf_top_sgnum.pt"
