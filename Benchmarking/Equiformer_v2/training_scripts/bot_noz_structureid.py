...
train_data = torch.load('./datasets/bot_noz_structureid_train.pt')
val_data = torch.load('./datasets/bot_noz_structureid_validation.pt')
test_data = torch.load('./datasets/bot_noz_structureid_test.pt')
wandb.init(project="equiformer_v2_fine_tune",id = "botnozstruc4",resume="allow")
...
stats = np.load("./datasets/wf_bot_structureid_stats.npz")      # ← your saved normalization constants
...
# Load Checkpoint
checkpoint_path = "./checkpoints/botnoz_struc1.pt"
