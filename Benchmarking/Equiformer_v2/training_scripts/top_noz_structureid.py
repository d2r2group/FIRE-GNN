...
train_data = torch.load('./datasets/top_noz_structureid_train.pt')
val_data = torch.load('./datasets/top_noz_structureid_validation.pt')
test_data = torch.load('./datasets/top_noz_structureid_test.pt')
wandb.init(project="equiformer_v2_fine_tune",id = "topnozstruc4",resume="allow")
...
# Load Checkpoint
checkpoint_path = "./checkpoints/topnoz_struc1.pt"
