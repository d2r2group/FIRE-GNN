...
from .relaxed_points_conv import RelaxedConvolution
...
class MessagePassing(torch.nn.Module):
    ...
    def forward(self, x, edge_index, edge_attr, node_attr, batch, additional_message_features=None) -> torch.Tensor:
        # x,
        # edge_index,
        # edge_attr,
        # node_attr,
        ...
        for lay in self.layers:
            node_features = lay(x, node_attr, edge_src, edge_dst, edge_attr, additional_message_features)
