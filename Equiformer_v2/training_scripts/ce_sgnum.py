...
train_data = torch.load('./datasets/sgnum_filtered_train.pt')
val_data = torch.load('./datasets/sgnum_filtered_validation.pt')
test_data = torch.load('./datasets/sgnum_test.pt')
wandb.init(project="equiformer_v2_fine_tune",id="cesgnum",resume="allow")
...
# Load Checkpoint
checkpoint_path = "./checkpoints/sgnum.pt"
start_epoch = 1
scaler = GradScaler()
