...
train_data = torch.load('./datasets/wf_top_element_train.pt')
val_data = torch.load('./datasets/wf_top_element_validation.pt')
test_data = torch.load('./datasets/wf_top_element_test.pt')
wandb.init(project="equiformer_v2_fine_tune",id = "wftopelement",resume="allow")
...
stats = np.load("./datasets/wf_top_element_stats.npz")      # ← your saved normalization constants
...
# Load Checkpoint
checkpoint_path = "./checkpoints/wf_top_element.pt"
